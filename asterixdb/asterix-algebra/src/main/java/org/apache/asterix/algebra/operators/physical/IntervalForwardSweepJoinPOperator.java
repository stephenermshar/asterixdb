...
public class IntervalForwardSweepJoinPOperator extends AbstractIntervalJoinPOperator {

    private final int memSizeInFrames;

    private static final Logger LOGGER = Logger.getLogger(IntervalForwardSweepJoinPOperator.class.getName());

    public IntervalForwardSweepJoinPOperator(JoinKind kind, JoinPartitioningType partitioningType,
    ...
    IOperatorDescriptor getIntervalOperatorDescriptor(int[] keysLeft, int[] keysRight, IOperatorDescriptorRegistry spec,
        ...
        return new IntervalForwardSweepJoinOperatorDescriptor(spec, memSizeInFrames, keysLeft, keysRight, recordDescriptor,
                mjcf);
    }
}