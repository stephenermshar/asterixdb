...
import org.apache.asterix.runtime.operators.joins.disjointintervalpartition.DisjointIntervalPartitionJoinOperatorDescriptor;
...
public class DisjointIntervalPartitionJoinPOperator extends AbstractIntervalJoinPOperator {
    private final int memSizeInFrames;

    private static final Logger LOGGER = Logger.getLogger(DisjointIntervalPartitionJoinPOperator.class.getName());

    public DisjointIntervalPartitionJoinPOperator(JoinKind kind, JoinPartitioningType partitioningType,
    ...
    public String getIntervalJoin() {
        return "DISJOINT_INTERVAL_PARTITION_JOIN";
    }
    ...
    IOperatorDescriptor getIntervalOperatorDescriptor(int[] keysLeft, int[] keysRight, IOperatorDescriptorRegistry spec,
        ...
        return new DisjointIntervalPartitionJoinOperatorDescriptor(spec, memSizeInFrames, keysLeft, keysRight, recordDescriptor,
                mjcf);
    }
