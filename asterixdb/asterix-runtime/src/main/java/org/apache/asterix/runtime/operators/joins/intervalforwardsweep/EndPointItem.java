...
public class EndPointItem implements Serializable {
    ...
    public static final Comparator<EndPointItem> EndPointAscComparator = new Comparator<EndPointItem>() {
        @Override
        public int compare(EndPointItem epi1, EndPointItem epi2) {
    ...
    public static final Comparator<EndPointItem> EndPointDescComparator = new Comparator<EndPointItem>() {
        @Override
        public int compare(EndPointItem epi1, EndPointItem epi2) {
    ...
    public EndPointItem(TuplePointer tp, byte start, long point) {
        reset(tp, start, point);
    }

    public void reset(EndPointItem item) {
