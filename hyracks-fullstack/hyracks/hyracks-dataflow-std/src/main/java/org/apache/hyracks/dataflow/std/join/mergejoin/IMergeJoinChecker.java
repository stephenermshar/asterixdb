...
public interface IMergeJoinChecker extends Serializable {
    ...
    boolean checkToIncrementMerge(ITupleAccessor accessorLeft, ITupleAccessor accessorRight)
            throws HyracksDataException;

    boolean checkToSaveInResult(long start0, long end0, long start1, long end1, boolean reversed);
